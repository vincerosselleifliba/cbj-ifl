...
<form class="form" id="add_edit_profile_summary" method="POST" action="{{ route('update.profile.summary', [$user->id]) }}">{{ csrf_field() }}
    <div class="form-body">
        ...
        <div class="form-group" id="div_summary">
            <label for="profile_headline" class="bold d-block">Profile Headline</label><br>
			<input type="text" class="form-control" name="profile_headline" id="profile_headline" placeholder="Profile Headline" />
		</div>
		...
		<div class="form-group" id="div_summary">
            <label for="keyword_tags" class="bold">Keyword Tags</label><br>
			<input type="text" class="form-control" name="keyword_tags" id="keyword_tags" placeholder="Profile Tags" />
		</div>

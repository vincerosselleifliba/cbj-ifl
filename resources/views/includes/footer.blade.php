...
<footer>
    <div class="b-btm">
        <div id="upper-footer" class="container">
            <div id="footer-logo">
                <img src="{{ asset('/') }}sitesetting_images/thumb/jobs-portal-white.png"
                    alt="{{ asset('/') }}sitesetting_images/thumb/jobs-portal-white.png" />
            </div>
            ...
            <div id="footer-language-selector">
                <div class="dropdown">
                    <button id="foot-lang-select" class="lang-btn" type="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                    ...
                    <ul class="dropdown-content footer-language-btn btn-fade">
                        ...
                        @foreach ($siteLanguages as $siteLang)
                            <li>
                                ...
                                <form id="locale-form-{{ $siteLang->iso_code }}" action="{{ route('set.locale') }}"
        ...
        <div class="mfdf">
                    ...
                    @foreach ($functionalAreas as $functionalArea)
                        <li>
                            <a
                                ...
                                href="{{ route('job.functional_areas', strtolower(str_replace(' ', '-', preg_replace('/\s*\([^)]*\)/', '', $functionalArea->functional_area)))) }}">{{ $functionalArea->functional_area }}
                                {{-- End of added some code in here --}}
                            </a>
                        </li>
                    @endforeach
                </ul>
            ...
            <div id="footer-hlinks">
                ...
                <ul class="quicklinks">
                    ...
                    @foreach ($industries as $industry)
                        <li><a
                                {{-- Added some code in here --}}
                                href="{{ route('job.industries', strtolower(str_replace(['/', ' '], ['-', '-'], preg_replace('/\s*\([^)]*\)/', '', $industry->industry)))) }}">{{ $industry->industry }}
                                {{-- End of added some code here --}}
                            </a>
                        </li>
                    @endforeach
                </ul>
            ...
            <div id="footer-account">
                ...
                <ul>
                    ...
                    <li><a href="mailto:{{ $siteSetting->mail_to_address }}">{{ $siteSetting->mail_to_address }}</a>
                    </li>
                    <li><a
    ...
    <div id="lower-footer">
        <div class="text-center">
            {{ __('Copyright') }} &copy; {{ date('Y') }} {{ $siteSetting->site_name }}.
